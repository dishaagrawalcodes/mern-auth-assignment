          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 pr-11 text-sm text-slate-900 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-900 transition-colors"
              />
